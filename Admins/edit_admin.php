     ...
     <?php
         ...
         //   echo "<div id='ed'>";
            ...
            if (isset($_POST['submit'])){
               ...
               $s="UPDATE admins SET name='".$_POST['name']."', email='".$_POST['email']."', phone='".$_POST['phone']."', username='".$_POST['username']."', password='".$_POST['password']."' WHERE id='".$_GET['id']."';"; 
               $sr=mysqli_query($con,$s) or die("Failed to edit this admin ".mysqli_connect_error());

               if ($sr) {
                  header("location:view_admins.php");
                  //header("location: edit_admin.php?id=".$_GET['id']."");
               }
            }else{
          ...
          if($nm == 1){
            ...
            echo "<div id='input'>";
             ...
             echo "<form method='POST' action='edit_admin.php?id=".$row['id']."'>";            
             echo "<tr>"; 
             echo "<td>ID</td>"; 
             echo "</tr>";            
             ...
             echo "<td>Phone</td>"; 
             echo "</tr>";            
             echo "<td><input type='password' name='phone' size='40' pattern='[0-9+ ]+$' value='".$row['phone']."' ></td>";
             echo "</tr>";
             echo "<tr>";   
             echo "<td>Roll</td>"; 
             echo "</tr>";         
