...
<body>
  ...
  <?php
       ...
       $sq="SELECT * FROM consultancy_requests WHERE status <=2 order by id desc";
       $sqr=mysqli_query($con,$sq) or die("failed to fetch requests!".mysqli_connect_error());
        ...
        echo "<td><a class='act' href='view_requests_end.php?id=".$id."'> Approve </a></td>";
         
        echo "<td><a class='act' href='reject_link.php?id=".$row['id']."' > Reject </a>";
        echo "</tr>";
